                        ...
                        <div class="page-title-box">
                            @can('create services')
                                <a class="btn btn-success"
                                    href="{{ route('admin.services.create') }}">{{ __('attributes.create') }}</a>
                            @endcan
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="header-title mt-0 mb-1">{{ __('attributes.services') }}</h4>
                                                        ...
                                                        @can('active services')
                                                            <div class="form-check form-switch">
                                                                <input class="form-check-input" type="checkbox" name="status"
                                                                    ...
                                                                    @if ($service->active == 1) checked @endif
                                                                    data-id="{{ $service->id }}">
                                                                <label class="form-check-label"
                                                                    for="active-{{ $service->id }}"></label>
                                                            </div>
                                                        @endcan
                                                    </td>
                                                    <td>
                                                            ...
                                                            <div class="modal-header">
                                                                <h4 class="modal-title" id="myCenterModalLabel">
                                                                    @lang('attributes.delete') : <span
                                                                        class="text-danger">{{ $service->title }}</span>
                                                                </h4>
