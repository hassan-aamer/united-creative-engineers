...
class ProductServiceService
{
    ...
    public function store(array $request)
    {
        try {
            ...
            $productServices = $this->itemRepository->createItem($this->model, $request);

            if (isset($request['image']) && $request['image']) {
                $productServices->addMediaFromRequest('image')->toMediaCollection('productServices');
            }
    ...
    public function update(array $request, int $id)
    {
        try {
            ...
            $productServices = $this->itemRepository->getItemById($this->model, $id);
            $this->itemRepository->updateItem($this->model, $id, $request);

            if (isset($request['image']) && $request['image']) {
                $productServices->clearMediaCollection('productServices');
                $productServices->addMediaFromRequest('image')->toMediaCollection('productServices');
            }
