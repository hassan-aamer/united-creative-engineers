...
namespace App\Services\InfoSectionDetails;

use App\Interfaces\CRUDRepositoryInterface;
use App\Models\InfoSectionDetail;
use Illuminate\Support\Facades\DB;

class InfoSectionDetailService
{
    private $model;
    ...
    public function __construct(CRUDRepositoryInterface $itemRepository)
    {
        ...
        $this->model = new InfoSectionDetail();
    }
    ...
    public function store(array $request)
    {
        try {
            ...
            $details = $this->itemRepository->createItem($this->model, $request);

            $this->syncRelations($details, $request, [
    ...
    public function update(array $request, int $id)
    {
        try {
            ...
            $details = $this->itemRepository->getItemById($this->model, $id);
